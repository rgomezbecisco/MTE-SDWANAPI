...
from mte_sdwanapi.api import (
    find_and_print_default_feature_templates,
...
if __name__ == "__main__":
    ...
    with create_manager_session(
        ...
        devices = get_reachable_devices(session, verbose=print_active)
        unique_template_ids = parse_unique_device_template_ids(devices, verbose=print_active)
        ...
        find_and_print_default_feature_templates(feature_template_definitions)
